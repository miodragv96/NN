...
%
%   For the training process we need two images.
%   One with which we want to train and a second image that contains the
...
%   pixel your dataset for training has x times y samples.
%
%  
%
%==========================================================================
...
width=1600; %Width of the picture you are working with
height=900; %Heigth of the picture you are working with
...
inputPicture = imread('plavaZutaTabla.png');
%Image with the labels corresponding to your inputPicture
labelPicture = imread('plavaZutaTabla_train.png');
